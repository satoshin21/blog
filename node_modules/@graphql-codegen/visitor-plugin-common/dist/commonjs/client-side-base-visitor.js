...
class ClientSideBaseVisitor extends index_1.BaseVisitor {
    constructor(_schema, _fragments, rawConfig, additionalConfig, documents) {
        super(rawConfig, {
            scalars: utils_1.buildScalars(_schema, rawConfig.scalars, scalars_1.DEFAULT_SCALARS),
            ...
            importOperationTypesFrom: utils_1.getConfigValue(rawConfig.importOperationTypesFrom, null),
            ...
            case DocumentMode.external:
                if (this._collectedOperations.length > 0) {
                    if (this.config.importDocumentNodeExternallyFrom === 'near-operation-file' && this._documents.length === 1) {
                        imports.push(`import * as Operations from './${this.clearExtension(path_1.basename(this._documents[0].filePath))}';`);
                    }
                    else {
